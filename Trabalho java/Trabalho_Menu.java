...
public class Trabalho {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("\nDigite o numero correspondede ou digite em sair: ");
        ...
        do {
            ...
            //pesquisa especializada
                ...
                System.out.println("--------------------------------------------------------------------");
                pesqfiltro(nome, carro, lavtipo, preco, i, i, n, c, l, filtro);
            }
            else{
                break;
            }
            ...
            } while (pergunta != 1 || pergunta != 2 || pergunta != 3 || pergunta != 4 || pergunta != 5);
    ...
    public static void pesqfiltro(String nome[], String carro[], String lav_tipo[], double preco[][], int carro_filtro, int lav_filtro, int n, int c[], int l[],  Scanner filtro)
    {
        do
        {
            System.out.println("\nSendo os tipos de carro como:");
        ...
        for(int i=0;i<n;i++) 
        {
            if(c[i] == carro_filtro && l[i] == lav_filtro)
            {
                ...
                System.out.println("Não há nenhum cliente dentro deste filtro");
                break;
            }
        }
    }
